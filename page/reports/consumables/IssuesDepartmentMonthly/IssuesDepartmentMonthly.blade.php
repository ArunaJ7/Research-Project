...
<div class="container">
    <div class="row">
        <div class="container" id="faccontainer">
            ...
            <br />
            <form action='{{url("/IssuesDepartmentMonthlyView")}}' method="GET">
                ...
                <div class="form-group form-row">
                    <div class="col-xl-12">
                        <label class="radio-inline">
                            <input type="radio" id="chkNo" required="required" name="chkPassPort" value="VI" checked/> Annual
                        </label>
                        <label class="radio-inline">
                ...
                <div class="form-group form-row" id="dvyear">
                    ...
                    <div class="col-sm-9">
                        <select id="year" name="year" class="form-control">   
                            @for ($year =date('Y')-30; $year <=date('Y')+50; $year++) 
                            <option value="{{$year}}" {{$year == date('Y') ? 'selected' : '' }}>{{$year}}</option>
                            @endfor
                        </select>
                    </div>
                </div>
                <div class="form-group form-row" id="dvPassport">
                ...
                <div class="form-group form-row" id="dvDateRange" >
            ...
            <script type="text/javascript">
                $(function() {
                $("input[name='chkPassPort']").ready(function () {
                     if ($("#chkYes").is(":checked")) {
                         $("#dvPassport").show();
                         $("#dvyear").show();
                         $("#dvDateRange").hide();
