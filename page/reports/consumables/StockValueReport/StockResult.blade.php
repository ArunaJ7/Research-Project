        ...
        <div class="row">
            <div class="col-md-12">
                <div class="sidebar">
                    ...
                    <a ref="hrdItem" data-no="{{$hrd->ch_ConHdr}}" href="#" target="">{{$hrd->ch_ConDesc}}</a>
                    @endforeach
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        $('a[ref="hrdItem"]').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{url("/reports/conItem/StockReport/results/")}}/' + next,
                data: {},
                dataType: 'json',
        ...
        $('a[ref="hrdAll"]').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{url("/reports/conItem/StockReport/total")}}',
                data: {},
                dataType: 'json',
                success: function(data) {
                    $('#ajaxResults').html(data.html);
