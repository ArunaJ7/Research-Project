...
<div class="container">
    <div class="row">
        <div class="container">
            <br /><br /><br /><br /><br />
            <h1 style='text-align:center'> Reports - Fixed Assets (GRN)</h1>
            <br /><br />
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ url('/reports/fxItem/grn/filter/results') }}">
                        {{csrf_field()}}

                        <div class="form-group form-row">
                            <div class="col-sm-6">
                                <label class="" for="ginNo"> GRN Number (From): </label>
                                <div class="">
