...
@section('title','FixedAssetNotIssuedToUser')
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        $('a[ref="ItemNo"]').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{url("/reports/fixItem/FixedAssetNotIssuedToUsers/filter/results/")}}/' + next,
                data: {},
                dataType: 'json',
        ...
        $('a[ref="hrdAll"]').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{url("/reports/fixItem/FixedAssetNotIssuedToUsers/filter/results-total")}}',
                data: {},
                dataType: 'json',
                success: function(data) {
                    $('#ajaxResult').html(data.html);
