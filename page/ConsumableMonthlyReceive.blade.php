...
@section('title','Consumable Items Received Details')
@section('content')
<div class="container">
    <div class="row">
        <div class="container" id="faccontainer">
            ...
            <h3> Annual Consumable Received Items Details </h3>
            <br />
            <form action='{{url("/consumableItemReceived")}}' method="GET">
                ...
                <div class="form-group form-row" id="dvyear">
                    ...
                    <div class="col-sm-9">
                        <select id="year" name="year" class="form-control">
                            @for ($year =date('Y')-40; $year <=date('Y')+10; $year++) 
