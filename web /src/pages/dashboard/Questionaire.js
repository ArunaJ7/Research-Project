...
// import BlocksGame from '../../components/blocks_game/BlocksGame';
            ...
            <Modal.Footer>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  window.open("https://e-learning-game.onrender.com", "_blank", "width=800,height=600,left=200,top=100");
              ...
              <div className="row justify-content-center mt-4">
                <div className="col-md-6">
                  <Card className="shadow custom-table">
                    <Card.Body>
                      <Card.Title>Your Preview</Card.Title>
                        {/* <FaceEmotion />
                        <BlocksGame /> */}
                    </Card.Body>
                  </Card>
