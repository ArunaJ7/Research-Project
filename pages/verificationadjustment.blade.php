    ...
    <div class="container" id="faccontainer">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form action="{{url('/save_VerifyAdjust')}}" method="POST">
          {{csrf_field()}}
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-9" >
                <label class="radio-inline">
                  <input type="radio" id="ph_type" required="required" name="ph_type" value="R"> Receive
                </label>

                <label class="radio-inline">
                  <input type="radio" id="ph_type" required="required" name="ph_type" value="I"> Issue
                </label>
              </div>
            </div>
          ...
          <table class="table table-dark">
            ...
            @foreach($verification_uitbl as $verification_tbl)
                <tr>
                  ...
                  <a href="{{url('/Delete_veifyadjust/').'/'.$verification_tbl->id}}" class="btn btn-danger">Delete</a>
                  @endcan
                </td>
                </tr>
            @endforeach
...
<script type="text/javascript">
  jQuery(document).ready(function ()
  {
    jQuery('select[name="ph_header"]').on('change',function(){
      ...
      {
        jQuery.ajax({
          url : '{{url("verificationadjustment/view_conItem_data/")}}/'+HeaderID,
          type : "GET",
          dataType : "json",
