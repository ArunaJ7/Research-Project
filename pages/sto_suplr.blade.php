...
<br> </br>
                ...
                <div class="form-group form-row">
                <label class="col-sm-3" for="reg_no">Supplier Registration Number</label>
                <div class="col-sm-9">
            <input value="" class="form-control" type="text" name="reg_no" placeholder="Enter Supplier Registration Number" required="required" id="reg_no">
                  </div>
                </div>
              ...
              <div class="form-group form-row">
                <label class="col-sm-3" for="add1">Address Line 01</label>
                <div class="col-sm-9">
              ...
              <div class="form-group form-row">
                <label class="col-sm-3" for="add2">Address Line 02</label>
                <div class="col-sm-9">
              ...
              <div class="form-group form-row">
                <label class="col-sm-3" for="add3">Address Line 03</label>
                <div class="col-sm-9">
              ...
              <div class="form-group form-row">
                <label class="col-sm-3" for="phone">Telephone No.</label>
                <div class="col-sm-9">
              ...
              <div class="form-group form-row">
                <label class="col-sm-3" for="email">E-mail Address</label>
                <div class="col-sm-9">
              ...
              <input type="reset" class="btn btn-warning" value="CLEAR">
                ...
                <td>{{ $fix_suplrs->Reg_No == 0 ? '-' : $fix_suplrs->Reg_No }}</td>

                <!--<td> {{$fix_suplrs->Reg_No}} </td>-->
