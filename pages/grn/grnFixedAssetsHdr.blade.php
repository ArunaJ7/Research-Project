...
<div class="container">
    <div class="row">
        ...
        <div class="container">
            ...
            <h1 style='text-align:center'> Fixed Assets Good Received Note  </h1>
            <br /><br />
            <div class="row">
                <div class="col-md-12">

                    <form method="post" action="{{ url('/addFxGrnHdr') }}">
                        {{csrf_field()}}
                            ...
                            <div class="col-sm-9">
                                <select class="form-control formselect required" placeholder="Select Supplier" id="supplier" name="supplier">
                                    ...
                                    <option value="{{$supplier->id}}">
                                        {{ ucfirst($supplier->Supplier) }} {{ $supplier->Reg_No == 0 ? '' : ' - '.$supplier->Reg_No }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
