...
@section('title','FixedAssetsItemList-Details')
@section('content')
<div class="container">
  <div class="row">
    <div class="container">
      <br /><br /><br /><br /><br />
      <h1 style='text-align:center'> Fixed Assets Item List - Details</h1>
      <form action='{{url("/FixedAssetsItemListview")}}' method="GET" onsubmit="return validateForm()">
        {{csrf_field()}}
        <br> </br>
